...
**Un bug découvert dans une tâche `done` donne une nouvelle tâche.** Jamais une réouverture, jamais une réédition du code sous couvert de la tâche terminée. Ce cas est permanent et non exceptionnel : une tâche est finie quand son critère est prouvé, pas quand son code est parfait, et prouver un critère n'a jamais signifié qu'il ne reste rien à corriger. Rouvrir dissoudrait la preuve — une entrée `proof` ancre un état de l'arbre à un instant donné, et ce contenu changerait sous elle sans que rien ne le signale, ce qui est exactement la falsification que l'ancrage existe pour rendre visible. La tâche neuve porte son propre scope et son propre critère, et cite celle dont elle corrige le travail. Premier exemple dans ce repo : `TASK-dc87e0ecfb6c` corrige la stratégie de reprise de verrou écrite par `TASK-244a842bc0cc`, laquelle reste `done` avec sa preuve intacte.
