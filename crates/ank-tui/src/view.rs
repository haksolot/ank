...
mod tests {
    ...
    fn snapshot() -> Snapshot {
        Snapshot {
            ...
            entities: vec![
                ...
                row("SPEC-77689b90b211", "spec", "accepted", "The CLI surface"),
            ],
            total: 3,
        }
    }
    ...
    fn the_list_narrows_on_every_keystroke_and_escape_gives_it_back() {
        ...
        assert_eq!(rendered_rows(&a), ["SPEC-77689b90b211"]);
    ...
    fn a_mouse_press_selects_the_row_it_landed_on() {
        ...
        for size in [PHONE, (120, 40)] {
            ...
            assert_eq!(
                ...
                Some("SPEC-77689b90b211")
            );
            // The mark is drawn on it, and on no other row.
            let frame = a.frame();
            let marked = frame
                .lines()
                .filter(|l| l.contains("> ") && l.contains("SPEC-7768"))
                .count();
    ...
    fn one_press_chooses_a_row_and_two_presses_on_it_open_it() {
        ...
        for size in [PHONE, (120, 40)] {
            ...
            assert!(
                reached_for(&a).contains("SPEC-77689b90b211"),
