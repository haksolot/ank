...
//! (ADR-4b45f344344f, TASK-2f7777a1fdff).
//!
...
//! line ADR-4b45f344344f draws to keep the watcher from becoming a third
...
//!
//! **A file, and deliberately not a socket.** ADR-4b45f344344f says the watcher
