...
/// `watch`, the watcher (ADR-4b45f344344f, ADR-1ea31c2f3c5a, §4).
///
/// **It answers no verb, and being started by one does not change that.** The
/// clause a reader meets first in ADR-4b45f344344f is the easiest one in this
...
fn dispatch(
    ...
    // (ADR-4b45f344344f). `watch` resolves no corpus at all: what it keeps warm
